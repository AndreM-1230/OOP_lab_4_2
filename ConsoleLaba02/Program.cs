...
namespace ConsoleLaba02
{
    ...
    class Program
    {
        //создать абстрактный класс, с одним методом, наследоваться от него и запретить наследование далее.
        ...
        static void Main(string[] args)
        {
            ...
            //teorya t1 = new abstractnaslednic();
            //t1.teorya1();
            //t1.teorya_1();
            //Console.ReadKey();

            teorya m1 = new abstractnaslednic();

            m1.teorya_1();
            //abstractnaslednic m2 = new teorya();
        }
    }
}
